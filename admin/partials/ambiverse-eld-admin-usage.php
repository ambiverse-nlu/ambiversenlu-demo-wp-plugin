...
<p class="description">
    ...
    <span class="shortcode wp-ui-highlight"><input type="text" id="wpcf7-shortcode" onfocus="this.select();" readonly="readonly" class="large-text code"
                                                   value="[ambiverse-eld coherent-document=&quot;<?php echo esc_attr( $atts['settings-coherent-document'] ); ?>&quot; confidence-threshold=<?php echo esc_attr( $atts['settings-threshold-document'] ); ?> language=&quot;en&quot;]When [[Who]] played Tommy in Columbus, Pete was at his best.[/ambiverse-eld]"></span>
</p>
